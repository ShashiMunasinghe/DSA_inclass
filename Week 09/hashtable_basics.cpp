...
struct HashTable{
    ...
    int hashfunc(string user_name){
        ...
        for (int i = 0; i < len; ++i) sum += (int)user_name[i];
    ...
    void insert(string user_name,string user_password){
        ...
        else cout << "No place to store." << endl;
    }
    void hash_lookup(string user_name){
        ...
        if (empty) cout << "does not exist in the hash table." << endl;
        else cout << "Password of " << user_name << ": " << password[hash] << endl;
    }
